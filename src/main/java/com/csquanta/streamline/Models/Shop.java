...
public class Shop implements Serializable {
    ...
    private final ArrayList<Item> buyedHeadWearList = new ArrayList<>();

    public ArrayList<Item> getBuyedHeadWearList() {
        return buyedHeadWearList;
    }
    ...
    public TreeSet<Item> firstInitializeArmor(){
        ...
        armorsList.add(new Item("/Images/gear/armor/Specials/sneakthiefRobes.png", "Sneak thief Robes", "600", "Armor"));
